...
def test_QFinder(
    ...
    all_labels, all_predictions, y_probs, all_keys = prediction_collector.get_results()
    ...
    df.to_csv("results_qfinder.csv", index=False)
    print("Saved results to results_qfinder.csv")
    # Calculate metrics
    ...
    cm_display.plot()
    plt.show()
    plt.savefig("QFinder_results.jpg",dpi=300)
